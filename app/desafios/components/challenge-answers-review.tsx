...
import { cardIdToLabel, cleanQuestionText } from "@/app/desafios/components/challenge-mappers";
        ...
        {attempt.challenge.questions.map((question) => {
          ...
          return (
            <article key={question.id} className={`${styles.reviewItem} ${statusClass}`}>
              ...
              <p className={styles.reviewQuestion}>{cleanQuestionText(question.questionText, attempt.challenge.isDaily)}</p>
